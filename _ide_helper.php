 ...
 * Generated for Laravel 5.2.29 on 2016-10-18.
 *
...
namespace {
    ...
    class CryptHash extends \App\Facades\CryptHash{
        ...
        public static function hash($value, $algo = 'sha256'){
            return \App\Security\CryptHash::hash($value, $algo);
        }
         ...
         * @static 
         */
        public static function check($value, $hash, $algo = 'sha256'){
            return \App\Security\CryptHash::check($value, $hash, $algo);
        }
    ...
    class LMPDF extends \App\Pdf\MpdfFacade{
         ...
         * @return \App\Pdf\Contracts\MpdfInstance 
         * @static 
         */
        public static function loadHtml($html, $format = 'A4'){
            return \App\Pdf\Mpdf::loadHtml($html, $format);
        }
         ...
         * @static 
         */
        public static function loadFile($file, $format = 'A4'){
            return \App\Pdf\Mpdf::loadFile($file, $format);
        }
         ...
         * @static 
         */
        public static function loadView($view, $params = array(), $format = 'A4'){
            return \App\Pdf\Mpdf::loadView($view, $params, $format);
        }
