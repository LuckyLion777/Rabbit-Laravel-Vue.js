...
use Media101\Chronicler\Chronicler;
...
class Repository implements RepositoryContract
{
    ...
    /**
     * Only makes sense if the object implements ChronicleSubject interface
     * @return Chronicler
     */
    public function getChronicler()
    {
        return $this->object->getChronicler();
    }
